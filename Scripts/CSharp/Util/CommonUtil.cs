    ...
    public class CommonUtil
    {
        ...
        public static void Battle_UpdateEntityStatus(Entity entity, bool isFinish = false)
        {
            ...
            if (porpertyComponent != null)
            {
                ...
                {
                    CommonUtil.Battle_SetEntityStatus(entity, ConstUtil.Status_PieceDead);
                }
                else if (porpertyComponent.atk > 0 && porpertyComponent.hp > 0)
                {
                    CommonUtil.Battle_SetEntityStatus(entity, isFinish ? ConstUtil.Status_PieceIdle : ConstUtil.None);
                }
                else if (porpertyComponent.atk <= 0)
                {
                    CommonUtil.Battle_SetEntityStatus(entity, ConstUtil.Status_PieceNoAtk);
                }
            }
        }
