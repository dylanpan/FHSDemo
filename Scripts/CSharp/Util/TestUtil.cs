...
public class TestUtil
{
    ...
    public static void SetTestPiecesIds(ref Entity aEntity, ref Entity bEntity)
    {
        ...
        if (bEntity != null)
        {
            ...
            {
                Dictionary<string, string> paramDict = TestUtil.GetCommonParamDict();
                paramDict["name"] = "凶残的野猪人";
                paramDict["atk"] = "2";
                paramDict["hp"] = "2";
                Entity pieces = TestUtil.GetTestPieces(paramDict);
