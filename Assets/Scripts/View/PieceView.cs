    ...
    private void OnPieceBuy()
    {
        if (piece != null)
        {
            ...
            if (CommonUtil.GetPieceBelong(piece.ID) == ConstUtil.Belong_Bartender)
            {
                ...
                Process.GetInstance().SetProcess(ConstUtil.Process_Prepare_Piece_Buy, Process.GetInstance().GetShowPlayerId());
            }
        }
    }
    private void OnPieceSell()
    {
        if (piece != null)
        {
            ...
            if (CommonUtil.GetPieceBelong(piece.ID) == ConstUtil.Belong_Hand_Card || CommonUtil.GetPieceBelong(piece.ID) == ConstUtil.Belong_Battle_Card)
            {
                ...
                Process.GetInstance().SetProcess(ConstUtil.Process_Prepare_Piece_Sell, Process.GetInstance().GetShowPlayerId());
            }
        }
    }
    private void OnPieceMove()
    {
        if (piece != null)
        {
            ...
            if (CommonUtil.GetPieceBelong(piece.ID) == ConstUtil.Belong_Hand_Card || CommonUtil.GetPieceBelong(piece.ID) == ConstUtil.Belong_Battle_Card)
            {
                ...
                Process.GetInstance().SetProcess(ConstUtil.Process_Prepare_Piece_Move, Process.GetInstance().GetShowPlayerId());
            }
        }
    }
